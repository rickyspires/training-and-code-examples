...
.marquee_photos { position: absolute; top: 0px; left: 0px; display: block; }
.marquee_caption {
	width: 700px;
	margin: 0px;
...
<div class="marquee_container">
		...
		<div class="marquee_panels">
			...
			<div class="marquee_panel">
				<img class="marquee_panel_photo" src="../../assets/img/slider1/photos/london.jpg" alt="London" width="100" />
			...
			<!-- Panel -->
			<div class="marquee_panel">
				<img class="marquee_panel_photo" src="../../assets/img/slider1/photos/milan.jpg" alt="Milan" width="100" />
				<div class="marquee_panel_caption">
			...
			<!-- Panel -->
			<div class="marquee_panel">
				<img class="marquee_panel_photo" src="../../assets/img/slider1/photos/staugustine.jpg" alt="St. Augustine" width="100" />
				<div class="marquee_panel_caption">
			...
			<!-- Panel -->
			<div class="marquee_panel">
				<img class="marquee_panel_photo" src="../../assets/img/slider1/photos/montreal.jpg" alt="Montreal" width="100" />
				<div class="marquee_panel_caption">
...
//JAVASCRIPT
	...
	// Preload all ../assets/img/slider1, then initialize marquee
