...
<div id="flipbook">
  ...
  <div>
    <div class="layer-trick"></div>
    frame<iframe src="http://google.com" width="100" height="100">iframe not supported </iframe>  frame </div>
    <div> Page 2 </div>
    <div> 3</div>
    <div> Page 4 </div>
    <div class="hard"></div>
...
$(document).ready(function() {
    $("#flipbook").turn({
	  ...
	  when: {
		...
		end: function(event,pageObj, corner) {
		  $(".layer-trick").hide();
		} 
	  }
